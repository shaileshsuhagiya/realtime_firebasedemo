...
class _AnimSearchBarState extends State<CustomAnimationSearchBar>
    ...
    return Container(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          color: widget.toggle == 1 ? widget.textFieldColor : widget.color,
        ...
        child: Stack(
          children: [
              ...
              child: AnimatedOpacity(
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    cursorWidth: 2.0,
                    onChanged: (value) =>
                        {widget.onChange(value), textFieldValue = value},
                    onSubmitted: (value) => {
                    ...
                    style: widget.style ??
                        AppTextStyle.style13w500ColorFFFFFF.copyWith(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle: AppTextStyle.style13w500ColorFFFFFF.copyWith(
                          color: AppColor.lightBlackColor,
                          fontFamily: "Regular"),
            ...
            Material(
              ...
              color: widget.toggle == 0 ? widget.color : widget.textFieldColor,
              borderRadius: BorderRadius.circular(30.0),
              child: IconButton(
                splashRadius: 19.0,
                ...
                onPressed: () {
                  ...
                  widget.searchBarOpen(widget.toggle);
                },
              ),
            ),
          ],
